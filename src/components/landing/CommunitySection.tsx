  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-4xl mx-auto text-center">
        ...
        {/* Stat Counters */}
        <motion.div
          className="flex flex-wrap items-center justify-center gap-12 md:gap-20 mb-12"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
        ...
        >
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-primary text-primary-foreground text-label-lg hover:bg-primary/90 transition-colors elevation-1 hover:elevation-2"
          >
            <svg
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-lg border border-border bg-card text-foreground text-label-lg hover:border-primary/50 hover:bg-card/80 transition-colors"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-5 w-5"
